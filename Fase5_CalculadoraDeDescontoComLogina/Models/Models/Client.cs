...
namespace Fase5_CalculadoraDeDescontoComLogin.Models.Models
{
    public class Client
    {
        ...
        {
            if (Products.Count == 2) return 10;
            else if (Products.Count > 2) return 20;
            else return 0;
        }
        ...
        public double CalculateTotalValueofProductsWithDiscount()
        {
            ...
            double totalValue = ReturnTotalValueOfProducts();

            return totalValue - discountPercent / 100 * totalValue;
        }
    }
}
